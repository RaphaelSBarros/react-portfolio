...
export default function Contact() {
  ...
  const contacts = [
    ...
    {
      name: "Email",
      description: "raphaelalexsandr01@gmail.com",
      link: "mailto:raphaelalexsandr01@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Joinville",
      description: "Parque Guarani",
      link: "https://maps.app.goo.gl/B7feSFHT8cV5J5Ai7",
